...
+ Выполни вёрстку адаптивной версии всех элементов главной страницы домашнего задания #7 (https://www.figma.com/file/jPzXB4xzDIfcOzPh6GBadb/Web-Studio-(Version-3.0)-(Copy)?node-id=297094%3A2124&t=WhpSACrj7FftT3ru-1).
...
Проект
+ «A1» При просмотре страницы на любом устройстве шириной от 480px, не появляется горизонтальная полоса прокрутки.
